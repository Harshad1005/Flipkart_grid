...
msg=Twist()
rospy.init_node("drivepy")
pub=rospy.Publisher("/bot1/drive",Twist,queue_size=10)
pub2=rospy.Publisher("/bot2/drive",Twist,queue_size=10)
pub3=rospy.Publisher("/bot3/drive",Twist,queue_size=10)
pub4=rospy.Publisher("/bot4/drive",Twist,queue_size=10)
